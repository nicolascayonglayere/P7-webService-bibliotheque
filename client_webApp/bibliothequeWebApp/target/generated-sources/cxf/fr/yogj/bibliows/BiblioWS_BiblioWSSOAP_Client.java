...
/**
 * This class was generated by Apache CXF 3.2.5 2018-10-17T14:05:16.120+02:00
...
public final class BiblioWS_BiblioWSSOAP_Client {
	...
	public static void main(String args[]) throws java.lang.Exception {
...

		{
			...
			fr.yogj.bibliows.ListRetardatairesResponse _listRetardataires__return = port
					.listRetardataires(_listRetardataires_parameters);
		...
		}
		{
			...
			fr.yogj.bibliows.ListNouveautesResponse _listNouveautes__return = port
					.listNouveautes(_listNouveautes_parameters);
		...
		}
		{
			...
			try {
				java.util.List<fr.yogj.bibliows.types.LivreEmpruntType> _obtenirEmpruntUtilisateur__return = port
						.obtenirEmpruntUtilisateur(_obtenirEmpruntUtilisateur_idUtilisateur);
		...
		}
		{
			...
			try {
				fr.yogj.bibliows.RechercheOuvrageResponse _rechercheOuvrage__return = port
						.rechercheOuvrage(_rechercheOuvrage_parameters);
		...
		}
		{
			...
			try {
				fr.yogj.bibliows.types.LivreEmpruntType _empruntOuvrage__return = port
						.empruntOuvrage(_empruntOuvrage_idLivre, _empruntOuvrage_idEmprunteur);
		...
		}
		{
			...
			try {
				fr.yogj.bibliows.types.LivreType _retourOuvrage__return = port
						.retourOuvrage(_retourOuvrage_idLivreEmprunt);
		...
		}
		{
			...
			try {
				fr.yogj.bibliows.types.LivreEmpruntType _prolongationOuvrage__return = port
						.prolongationOuvrage(_prolongationOuvrage_idEmprunt);
