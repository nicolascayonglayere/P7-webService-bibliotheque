...
/**
 * <p>
 * Classe Java pour UtilisateurType complex type.
 * 
 * <p>
...
@XmlType(name = "UtilisateurType", propOrder = { "id", "nom", "prenom", "pseudo", "motDePasse", "coordonnee",
		"emprunt" })
public class UtilisateurType {
	...
	public List<CoordonneeUtilisateurType> getCoordonnee() {
		if (this.coordonnee == null) {
			this.coordonnee = new ArrayList<CoordonneeUtilisateurType>();
		}
	...
	public List<LivreEmpruntType> getEmprunt() {
		if (this.emprunt == null) {
			this.emprunt = new ArrayList<LivreEmpruntType>();
		}
		return this.emprunt;
	}
