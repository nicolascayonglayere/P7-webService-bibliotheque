...
public interface BiblioWS {
    ...
    public void empruntOuvrage(
        @WebParam(name = "id", targetNamespace = "")
        int id,
        @WebParam(name = "idEmprunteur", targetNamespace = "")
        int idEmprunteur,
        @WebParam(mode = WebParam.Mode.OUT, name = "livre", targetNamespace = "")
        javax.xml.ws.Holder<fr.yogj.bibliows.types.LivreEmpruntType> livre,
        @WebParam(mode = WebParam.Mode.OUT, name = "dateRetour", targetNamespace = "")
        javax.xml.ws.Holder<javax.xml.datatype.XMLGregorianCalendar> dateRetour
