 ...
 *         &lt;element name="coordonnee" type="{http://www.yogj.fr/biblioWS/types}CoordonneeUtilisateur" maxOccurs="unbounded"/&gt;
 *         &lt;element name="emprunt" type="{http://www.yogj.fr/biblioWS/types}LivreEmprunt" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Utilisateur {
    ...
    @XmlElement(required = true)
    protected List<CoordonneeUtilisateur> coordonnee;
    @XmlElement(required = true)
    protected List<LivreEmprunt> emprunt;
    ...
    public List<LivreEmprunt> getEmprunt() {
        if (emprunt == null) {
            emprunt = new ArrayList<LivreEmprunt>();
        }
        return this.emprunt;
    }
